...
import 'package:sqlite3_arabic_phonetic_fuzzy_trigram_flutter_example/provider/app_provider.dart';
          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemCount: Provider.of<AppProvider>(context).results.length,
                itemBuilder: (context, index) {
                  return Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Html(
                      data: Provider.of<AppProvider>(
                        context,
